<html>
    ...
    <body class="w3-pale-red">
        ...
        <div id="idSideDataAdd" class="rom-side-data w3-pale-yellow ">
            <div class="w3-bar w3-xlarge w3-blue-grey ">
                <span class="w3-bar-item">TAMBAH RAYON</span>
            ...
            <div class="w3-panel">
                <form action="do.php" id="frmMainAdd" method="post" autocomplete="off">
                    ...
                    <table class="w3-table-all">
                        <tr>
                            <th>Lokasi / Area (Parent)</th>
                            <td><select class="w3-input w3-border w3-padding-small" name="iLocAreaId" id="idAddLocArea_id" ><?php echo $PAGE['form']['cbLocArea']; ?></select></td>
                        </tr>
                        <tr>
                            <th>ID Rayon</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iRayonId" id="idAddRayon_id" maxlength="16" /></td>
                        </tr>
                        <tr>
                            <th>Nama Rayon</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iRayonName" id="idAddRayon_name" maxlength="25" /></td>
                        </tr>
                        <tr>
                            <th>Index Rayon</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iRayonIndex" id="idAddRayon_index" maxlength="3" /></td>
                        </tr>
                    </table>
        ...
        <div id="idSideDataEdit" class="rom-side-data w3-pale-yellow ">
            <div class="w3-bar w3-xlarge w3-blue-grey ">
                <span class="w3-bar-item">EDIT RAYON</span>
            ...
            <div class="w3-panel">
                <form action="do.php" id="frmMainEdit" method="post" autocomplete="off">
                    ...
                    <table class="w3-table-all">
                        <tr>
                            <th>Lokasi / Area (Parent)</th>
                            <td><select class="w3-input w3-border w3-padding-small" name="iLocAreaId" id="idEditLocArea_id" ><?php echo $PAGE['form']['cbLocArea']; ?></select></td>
                        </tr>
                        <tr>
                            <th>ID Area</th>
                            <td id="idEditRayon_id"></td>
                        </tr>
                        <tr>
                            <th>Nama Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iRayonName" id="idEditRayon_name" maxlength="25" /></td>
                        </tr>
                        <tr>
                            <th>Index Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iRayonIndex" id="idEditRayon_index" maxlength="3" /></td>
                        </tr>
                    </table>
                    <div class="w3-container w3-margin-top w3-right-align">
        ...
        <div class="w3-bar w3-xlarge w3-red">
            ...
            <span class="w3-bar-item">S3. DAFTAR RAYON</span>
    ...
    <script>
        ...
        function funcDataView(iProdID) {
            ...
            $.getJSON("do.php?navcmd=S3,VIEW&id=" + iProdID, function (varRes) {
                if (varRes.status) {
        ...
        function funcBtnEdit(iProdID) {
            ...
            $.getJSON("do.php?navcmd=S3,VIEW&id=" + iProdID, function (varRes) {
                if (varRes.status) {
                    $("#idEditLocArea_id").val(varRes.data.locArea_id);
                    $("#idEditRayon_id").text(varRes.data.rayon_id);
                    $("#idEditRayon_name").val(varRes.data.rayon_name);
                    $("#idEditRayon_index").val(varRes.data.rayon_index);
                }
            });
