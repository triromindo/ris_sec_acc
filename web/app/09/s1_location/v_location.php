<html>
    ...
    <body class="w3-pale-red">
        ...
        <div id="idSideDataAdd" class="rom-side-data w3-pale-yellow ">
            <div class="w3-bar w3-xlarge w3-blue-grey ">
                <span class="w3-bar-item">TAMBAH LOKASI</span>
            ...
            <div class="w3-panel">
                <form action="do.php" id="frmMainAdd" method="post" autocomplete="off">
                    ...
                    <table class="w3-table-all">
                        <tr>
                            <th>ID Lokasi</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iLocId" id="idAddLoc_id" maxlength="16" /></td>
                        </tr>
                        <tr>
                            <th>Nama Lokasi</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iLocName" id="idAddLoc_name" maxlength="25"/></td>
                        </tr>
                        <tr>
                            <th>Index Lokasi</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iLocIndex" id="idAddLoc_index" maxlength="3" /></td>
                        </tr>
                    </table>
        ...
        <div id="idSideDataEdit" class="rom-side-data w3-pale-yellow ">
            <div class="w3-bar w3-xlarge w3-blue-grey ">
                <span class="w3-bar-item">EDIT LOKASI</span>
            ...
            <div class="w3-panel">
                <form action="do.php" id="frmMainEdit" method="post" autocomplete="off">
                    ...
                    <table class="w3-table-all">
                        <tr>
                            <th>ID Lokasi</th>
                            <td id="idEditLoc_id"></td>
                        </tr>
                        <tr>
                            <th>Nama Lokasi</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iLocName" id="idEditLoc_name" maxlength="25" /></td>
                        </tr>
                        <tr>
                            <th>Index Lokasi</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iLocIndex" id="idEditLoc_index" maxlength="3" /></td>
                        </tr>
                    </table>
                    <div class="w3-container w3-margin-top w3-right-align">
        ...
        <div class="w3-bar w3-xlarge w3-red">
            ...
            <span class="w3-bar-item">S1. DAFTAR LOKASI</span>
    ...
    <script>
        ...
        function funcDataView(iProdID) {
            ...
            $.getJSON("do.php?navcmd=S1,VIEW&id=" + iProdID, function (varRes) {
                if (varRes.status) {
        ...
        function funcBtnEdit(iProdID) {
            ...
            $.getJSON("do.php?navcmd=S1,VIEW&id=" + iProdID, function (varRes) {
                if (varRes.status) {
                    $("#idEditLoc_id").text(varRes.data.loc_id);
                    $("#idEditLoc_name").val(varRes.data.loc_name);
                    $("#idEditLoc_index").val(varRes.data.loc_index);
                }
            });
