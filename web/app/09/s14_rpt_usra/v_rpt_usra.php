<html>
    ...
    <head>
        <title>System Lap Aktivitas User</title>
    ...
    <body class="w3-pale-red">
        ...
        <div class="w3-bar w3-xlarge w3-red" id="idDivBanner">
            ...
            <span class="w3-bar-item">S14. LAPORAN AKTIVITAS USER</span>
        </div>


        <div class="w3-panel" id="idDivQuery">
            <form action="do.php" id="frmMain" method="post" autocomplete="off">
                <input type="hidden" name="navcmd" value="S14" />
                <table class="w3-table-all" style="width:100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="iUser" class="w3-select w3-border w3-padding-small" style="width: unset;" >
                    ...
                    <tbody>
                        ...
                        if (isset($PAGE['form']['table'])) {
                            foreach ($PAGE['form']['table'] as $keyUser => $valUser) {
                                $varName = $keyUser.'<br>'. $PAGE['form']['table_modname'][$keyUser];
