<html>
    ...
    <head>
        <title>System Log Ris Sales</title>
    ...
    <body class="w3-pale-red">
        ...
        <div class="w3-bar w3-xlarge w3-red" id="idDivBanner">
            ...
            <span class="w3-bar-item">S11. LOG AKTIVITAS RIS SALES</span>
        </div>
        ...
        <div class="w3-panel" id="idDivQuery">
            <form action="do.php" id="frmMain" method="post" autocomplete="off">
                ...
                <input type="hidden" name="navcmd" value="S11" />
                <table class="w3-table-all" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="iUser" value="<?php echo $PAGE['form']['valUser']; ?>" class="w3-input w3-border"  />
                        </td>
                        <td>
