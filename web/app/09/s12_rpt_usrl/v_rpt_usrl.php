<html>
    ...
    <head>
        <title>System Lap Login User</title>
    ...
    <body class="w3-pale-red">
        ...
        <div class="w3-bar w3-xlarge w3-red" id="idDivBanner">
            ...
            <span class="w3-bar-item">S12. LAPORAN LOGIN USER</span>
        </div>
            ...
            <form action="do.php" id="frmMain" method="post" autocomplete="off">
                ...
                <table class="w3-table-all" style="width:100%">
                    <tr>
                        ...
                        <td>
                            <button class="w3-button w3-green w3-small w3-round-xxlarge" onclick="funcBtnQuery()">Query</button>
                            <button class="w3-button w3-green w3-small w3-round-xxlarge" onclick="funcBtnDownload()">Download Excel</button>
                        </td>
                    </tr>
                </table>
            </form>
                            ...
                            foreach ($PAGE['form']['table'] as $keyUser => $valUser) {
                                ...
                                <tr>
                                    ...
                                    for ($i = 1; $i <= 31; $i++) {
                                        ...
                                        ?>
                                        <td class="w3-right-align"><?php echo $val; ?></td>
                                        <?php
                                    }
                                    ?>
...
//            });
            ...
            function funcBtnQuery() {
                $("#navcmd").val('<?php echo $PAGE['ID']; ?>,REPORT');
                $("#frmMain").submit();
            }
            function funcBtnDownload() {
                $("#navcmd").val('<?php echo $PAGE['ID']; ?>,DOWNLOAD');
                $("#frmMain").submit();
            }
