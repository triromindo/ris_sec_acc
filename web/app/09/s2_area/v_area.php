<html>
    ...
    <body class="w3-pale-red">
        ...
        <div id="idSideDataAdd" class="rom-side-data w3-pale-yellow ">
            <div class="w3-bar w3-xlarge w3-blue-grey ">
                <span class="w3-bar-item">TAMBAH AREA</span>
            ...
            <div class="w3-panel">
                <form action="do.php" id="frmMainAdd" method="post" autocomplete="off">
                    ...
                    <table class="w3-table-all">
                                                <tr>
                            <th>Lokasi (Parent)</th>
                            <td><select class="w3-input w3-border w3-padding-small" name="iLocID" id="idAddLoc_id" ><?php echo $PAGE['form']['cbLoc']; ?></select></td>
                        </tr>
                        <tr>
                            <th>ID Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iAreaId" id="idAddArea_id" maxlength="16" /></td>
                        </tr>
                        <tr>
                            <th>Nama Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iAreaName" id="idAddArea_name" maxlength="25" /></td>
                        </tr>
                        <tr>
                            <th>Index Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iAreaIndex" id="idAddArea_index" maxlength="3" /></td>
                        </tr>
                    </table>
        ...
        <div id="idSideDataEdit" class="rom-side-data w3-pale-yellow ">
            <div class="w3-bar w3-xlarge w3-blue-grey ">
                <span class="w3-bar-item">EDIT AREA</span>
            ...
            <div class="w3-panel">
                <form action="do.php" id="frmMainEdit" method="post" autocomplete="off">
                    ...
                    <table class="w3-table-all">
                        <tr>
                            <th>Lokasi (Parent)</th>
                            <td><select class="w3-input w3-border w3-padding-small" name="iLocID" id="idEditLoc_id" ><?php echo $PAGE['form']['cbLoc']; ?></select></td>
                        </tr>
                        <tr>
                            <th>ID Area</th>
                            <td id="idEditArea_id"></td>
                        </tr>
                        <tr>
                            <th>Nama Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iAreaName" id="idEditArea_name" maxlength="25" /></td>
                        </tr>
                        <tr>
                            <th>Index Area</th>
                            <td><input type="text" class="w3-input w3-border w3-padding-small" name="iAreaIndex" id="idEditArea_index" maxlength="3" /></td>
                        </tr>
                    </table>
                    <div class="w3-container w3-margin-top w3-right-align">
        ...
        <div class="w3-bar w3-xlarge w3-red">
            ...
            <span class="w3-bar-item">S2. DAFTAR AREA</span>
    ...
    <script>
        ...
        function funcDataView(iProdID) {
            ...
            $.getJSON("do.php?navcmd=S2,VIEW&id=" + iProdID, function (varRes) {
                if (varRes.status) {
        ...
        function funcBtnEdit(iProdID) {
            ...
            $.getJSON("do.php?navcmd=S2,VIEW&id=" + iProdID, function (varRes) {
                if (varRes.status) {
                    $("#idEditLoc_id").val(varRes.data.loc_id);
                    $("#idEditArea_id").text(varRes.data.area_id);
                    $("#idEditArea_name").val(varRes.data.area_name);
                    $("#idEditArea_index").val(varRes.data.area_index);
                }
            });
